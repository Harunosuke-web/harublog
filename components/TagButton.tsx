...
export default function TagButton({
  ...
  const baseStyles = "text-xs font-medium transition-colors relative z-10";
  ...
  const variantStyles = {
    default: `px-1.5 py-0.5 cursor-pointer ${
      isTagActive
        ? 'bg-black/90 text-green-500 dark:text-green-400'
        : 'bg-black/90 text-gray-300 hover:bg-black/80 hover:text-blue-400'
    }`,
    inline: `inline-flex items-center px-3 py-1.5 text-sm rounded-lg border border-gray-200 dark:border-gray-700 cursor-pointer ${
      isTagActive
        ? 'bg-white dark:bg-gray-900 text-green-500 dark:text-green-400'
